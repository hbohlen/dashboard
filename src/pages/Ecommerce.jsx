                ...
                <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
                    <div className="flex justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <p className="items-center gap-2 text-gray-600 hover:drop-shadow-x1">
                                <span><GoPrimitiveDot /></span>
                                <span>Expense</span>
                            </p>

                            <p className="items-center gap-2 text-green-600 hover:drop-shadow-x1">
                                <span><GoPrimitiveDot /></span>
                                <span>Budget</span>
                            </p>
                        </div>
                    ...
                    <div className="mt-10 flex gap flex-wrap justify-center">
                        <div className="border-r-1 border-color m-4 pr-10">
                            <div>
                                <span className="text-3xl font-semibold">$48838</span>
